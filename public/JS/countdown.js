...
!function(n, t) {
    ...
    const o = function(n, t) {
        ...
        a && n.Blocks.add(s, e({
            ...
            label: l,
            attributes: {
                title: "A block you can use for countdown"
            },
            category: 'Extra',
            select: !0,
            content: {
                ...
                defaults: e({
                    ...
                    script: function(n) {
                        ...
                        p.forEach((function(n) {
                            n.isConnected || (clearInterval(n.__gjsCountdownInterval),
                            v.push(n))
                        }
                        )),
                        ...
                        var y = function(n, t, e, o) {
                          ...
                          , f = function() {
                            ...
                            y(s, l, i, r),
                            t < 0 && (clearInterval(o.__gjsCountdownInterval),
                            d.innerHTML = e,
                            c.style.display = 'none',
                            d.style.display = '')
                        };
                        a ? (o.__gjsCountdownInterval = setInterval(f, 1e3),
