            ...
            if (!b && i) {
                ...
                function t(e) {
                    if (e.length) {
                        ...
                        n.src = e.shift(),
                        n.onerror = n.onload = t.bind(null, e),
                        y.appendChild(n)
                    } else
                        b = h()
                }(v)
            ...
            t.Commands.add(m, {
                run: function(t, e) {
                    var n = this
                      ...
                      , i = this.id;
                    if (!b)
                        return t.log("TOAST UI Image editor not found", {
                            level: "error",
                            ns: m
                        }),
                        t.stopCommand(i);
                ...
                getEditorConfig: function() {
                    ...
                    return t.includeUI || (t.includeUI = {}),
                    t.includeUI = a()({
                        theme: {}
                    }, t.includeUI, {
                        loadImage: {
                ...
                uploadImage: function(t, e, n) {
                    ...
                    if (f) {
                        ...
                        g && n.add({
                            src: r,
                            name: (e.get("src") || "").split("/").pop()
                        }),
                        this.applyToTarget(r)
                },
                ...
                dataUrlToBlob: function(t) {
                    for (var e = t.split(","), n = window.atob(e[1]), o = e[0].split(":")[1].split(";")[0], r = new ArrayBuffer(n.length), i = new Uint8Array(r), a = 0; a < n.length; a++)
                        i[a] = n.charCodeAt(a);
                    return new Blob([r],{
                        type: o
                    })
