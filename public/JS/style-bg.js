        ...
        180: function(e) {
            ...
            t = () => ( () => {
                              ...
                              , p = function(e) {
                                ...
                                a(t, [{
                                    ...
                                    value: function(e, t) {
                                        ...
                                        return ["linear", "repeating-linear"].indexOf(r) >= 0 && o.indexOf(i) >= 0 && (i = "center" === i ? "to right" : "to " + i),
                                        ["radial", "repeating-radial"].indexOf(r) >= 0 && o.indexOf(i) >= 0 && (i = "circle at " + i),
                                        n ? r + "-gradient(" + i + ", " + n + ")" : ""
                                    }
                                }, {
                                    key: "getSafeValue",
                                    value: function(e, t) {
                                        ...
                                        for (var o = this.sandEl.style, i = [r].concat(function(e) {
                                            ...
                                            return Array.from(e)
                                        }(this.getPrefixedValues(e, t))), a = void 0, l = 0; l < i.length && (a = i[l],
                                        o.backgroundImage = a,
                                        o.backgroundImage != a); l++)
                                            ;
                                    ...
                                    value: function() {
                                        var e = this.handlers;
                                        return e.sort(s),
                                        (e = 1 == e.length ? [e[0], e[0]] : e).map((function(e) {
                                            return e.getValue()
                                        }
                                        )).join(", ")
                                    }
                                    ...
                                    value: function(e, t) {
                                        ...
                                        return !r.silent && this.emit("handler:add", o),
                                        o
                                    }
                                }, {
                                    key: "getHandler",
                                        ...
                                        var e = this
                                          ...
                                          , p = function(t) {
                                            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1
                                              , r = t.target.value;
                                            e.setColor(r, n),
                                            u && (u.style.backgroundColor = r)
                                        };
                                        if (c && (0,
                                        i.on)(c, "click", (function(e) {
                                            return e.stopPropagation()
                                        }
                                        )),
                                        l && (0,
                                        i.on)(l, "click", (function(t) {
                                            t.stopPropagation(),
                                            e.remove()
                                        }
                                        )),
                                        ...
                                        d) {
                                            var f = 0
                                              ...
                                              , b = function(t) {
                                                ...
                                                (0,
                                                i.isDef)(t.button) && 0 === t.which && k(t)
                                            }
                                              , k = function t(n) {
                                                (0,
                                                i.off)(document, "touchmove mousemove", b),
                                                (0,
                                                i.off)(document, "touchend mouseup", t),
                                                v && (v = 0,
                                                e.setPosition(f),
                                                e.emit("handler:drag:end", e, f))
                                            };
                                            (0,
                                            i.on)(d, "touchstart mousedown", (function(t) {
                                                if (!(0,
                                                i.isDef)(t.button) || 0 === t.button) {
                                                    e.select();
                                                    var r = (0,
                                                    i.getPointerEvent)(t);
                                                    h = e.position,
                                                    ...
                                                    y.y = r.clientY,
                                                    (0,
                                                    i.on)(document, "touchmove mousemove", b),
                                                    (0,
                                                    i.on)(document, "touchend mouseup", k),
                                                    e.emit("handler:drag:start", e)
                                                }
                                            }
                                            )),
                                            (0,
                                            i.on)(d, "click", (function(e) {
                                                return e.stopPropagation()
                                            }
                                            ))
                                        }
                ...
                return ( () => {
                    ...
                    var e = n(9)
                      , t = n.n(e)
                      , o = void 0 && (void 0).__assign || function() {
                      ...
                      , a = function(e) {
                        ...
                        if (!r)
                            return i;
                        o.length > 2 && (i.direction = o.shift(),
                      ...
                      , l = function(e, t, n) {
                        var r = i(i([], u, !0), ['center'], !1)
                          , o = t;
                        return ['linear', 'repeating-linear'].indexOf(e) >= 0 && r.indexOf(o) >= 0 && (o = 'center' === o ? 'to right' : "to ".concat(o)),
                        ...
                        function(e, n) {
                            ...
                            y && i.addType(y, {
                                ...
                                update: function(e) {
                                    ...
                                    if (r.getValue() !== t) {
                                        ...
                                        n.selectEdgeStops && [o[0], o[o.length - 1]].filter(Boolean).map((function(e) {
                                            return e.select({
                                                keepSelect: !0
                                            })
                                        }
                            ...
                            g && i.addBuiltIn(g, {
                                ...
                                fromStyle: function(e, t) {
                                    var n, r = t.name, o = a(e[r] || ''), i = o.type || s[0], d = c(o.direction) || u[0];
                                    return (n = {})[p] = l(i, d, o.colors),
                                    n[h] = i,
                                    n[f] = d,
                                    n
                                },
                                toStyle: function(e, t) {
                                    var n, r = t.name, o = e[p] || '', i = e[h] || s[0], c = e[f] || u[0], d = a(o), v = l(i, c, d.colors);
                                    return (n = {})[r] = v,
                                    n
                                },
                                properties: [{
        ...
        var a = function(e) {
          ...
          , l = function(n) {
            ...
            if (n.indexOf('url(') > -1)
                ...
                t.parseGradient)(n)
                  , a = i.stops;
                if (2 === a.length && 'linear' === i.type && a[0].color === a[1].color)
                    o[s] = e.Color,
                    o[p] = a[0].color;
                else {
                    var l = (0,
                    t.getValidDir)(i.direction) || t.GRAD_DIRS[0]
                      , c = i.type || t.GRAD_TYPES[0];
                    o[s] = e.Grad,
                    o[f] = (0,
                    t.toGradient)(c, l, i.colors),
                    o[v] = c,
                    o[h] = l
                }
            }
            ...
            n.Styles.addBuiltIn('background', {
                ...
                fromStyle: function(e, t) {
                    var n = t.property
                      ...
                      , a = n.getProperties()
                      , c = [];
                    return e[u] ? (c = n.__splitStyleName(e, u, o).map(l),
                    a.forEach((function(t) {
                        var r = t.getId()
                          , a = t.getName();
                        a !== u && n.__splitStyleName(e, a, o).map((function(e) {
                            var n;
                            return (n = {})[r] = e || t.getDefaultValue(),
                            n
                        }
                ...
                toStyle: function(n) {
                    ...
                    if (o === e.Color) {
                        ...
                        t.parseGradient)(r[f] || '');
                        a = (0,
                        t.toGradient)(r[v] || t.GRAD_TYPES[0], r[h] || t.GRAD_DIRS[0], c.colors)
                    }
                    return delete r[d],
                    delete r[p],
                    delete r[f],
                ...
                properties: [{
                    ...
                    onChange: function(t) {
                        ...
                        r && n.getParent().getProperties().forEach((function(t) {
                            var n = t.getName()
                              , o = !1;
                            n !== s && ((r === e.Image && [p, f, h, v].indexOf(n) < 0 || r === e.Color && n === p || r === e.Grad && [f, h, v].indexOf(n) >= 0) && (o = !0),
                            t.up({
                                visible: o
                            }))
                        }
