    ...
    panels: { defaults: [{
      ...
      },
      {
        ...
        buttons: [{
            ...
            id: 'device-mobile',
            label: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="-8 -8 40 40" style="fill: currentColor;transform: ;msFilter:;"><path d="M17 2H7c-1.103 0-2 .897-2 2v16c0 1.103.897 2 2 2h10c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2zM7 16.999V5h10l.002 11.999H7z"></path></svg>',
  ...
  editor.Panels.addPanel({
    ...
    buttons: [
      ...
      },
      {
        ...
        label: `<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="-8 -8 40 40" style="fill: currentColor; display: block;"><path d="M5 21h14a2 2 0 0 0 2-2V8l-5-5H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2zM7 5h4v2h2V5h2v4H7V5zm0 8h10v6H7v-6z"></path></svg>`,
        attributes: {
          title: "Save Project",
        }
      }
...
function saveToFirebase() {
    ...
    loading.style.backgroundColor = "#13171F";
